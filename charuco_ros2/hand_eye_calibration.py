...
def run_hand_eye_calibration(data_dir: Path) -> Tuple[np.ndarray, np.ndarray]:
    ...
    Returns
    -------
    (R_cam2gripper, t_cam2gripper): tuple of ndarray
        Estimated rotation matrix and translation vector mapping camera
        coordinates to robot gripper coordinates.
    """
...
def main() -> None:
    ...
    R_cam2gripper, t_cam2gripper = run_hand_eye_calibration(args.data_dir)
